...
**Mục đích:** Làm sạch ảnh nhị phân (mặt nạ phân vùng).
...
**Tham số:** Phần tử cấu trúc (ma trận nhân) hình vuông kích thước 7×7, số lần lặp = 3.
...
### 2A. Tách vật dính bằng phép co
**Khi nào cần?** Khi 2 sản phẩm nằm quá sát nhau → đường viền của chúng bị gộp thành 1 khối lớn.

**Cách hoạt động:**
1. Nếu phát hiện `diện_tích > diện_tích_tối_đa × 1.5` → nghi ngờ đây là nhiều vật dính liền.
2. Áp dụng **phép co** với số lần lặp tăng dần.
3. Phần nối mỏng giữa 2 vật thể sẽ bị thu nhỏ và xóa mất trước → 2 vật thể tự động tách ra thành 2 đường viền riêng biệt.
4. Cuối cùng áp dụng **phép nở** trở lại để khôi phục kích thước ban đầu.
...
| Kích thước phần tử cấu trúc | Vuông 7×7 | Kích thước ma trận trượt để quét thực hiện phép co/nở |
...
| Khoảng cách ghép tối đa | 60-120 | Khoảng cách giới hạn (tính bằng điểm ảnh) để ghép vết theo dõi |
